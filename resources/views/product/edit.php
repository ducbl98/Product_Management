            ...
            <div class="col-12">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="number" value="<?php echo $product->number?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="dateCreate" value="<?php echo $product->dateCreate?>">
